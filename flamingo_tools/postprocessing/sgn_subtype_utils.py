...
COCHLEAE = {
    "M_LR_000098_L": {"seg_data": "SGN_v2", "stains": ["PV", "CR", "Ntng1"],
                      "subtype_stains": ["CR", "Ntng1"], "intensity": "ratio",
                      "component_list": [1, 2]},
    "M_LR_000099_L": {"seg_data": "PV_SGN_v2", "stains": ["PV", "Calb1", "Lypd1"],
                      "subtype_stains": ["Calb1", "Lypd1"], "intensity": "ratio"},
    "M_LR_000184_L": {"seg_data": "SGN_v2", "stains": ["PV", "Prph"],
                      "subtype_stains": ["Prph"], "output_seg": "SGN_v2b", "intensity": "ratio"},
    "M_LR_000184_R": {"seg_data": "SGN_v2", "stains": ["PV", "Prph"],
                      "subtype_stains": ["Prph"], "output_seg": "SGN_v2b", "intensity": "ratio"},
    "M_LR_000260_L": {"seg_data": "SGN_v2", "stains": ["PV", "Prph", "Tuj1"],
                      "subtype_stains": ["Prph"], "intensity": "ratio"},
    "M_LR_N98_R": {"seg_data": "SGN_v2", "stains": ["PV", "CR", "Ntng1"],
                   "subtype_stains": ["CR", "Ntng1"], "intensity": "ratio"},
    "M_LR_N110_L": {"seg_data": "SGN_v2", "stains": ["PV", "Calb1", "Ntng1"],
                    "subtype_stains": ["Calb1", "Ntng1"], "intensity": "ratio"},
    "M_LR_N110_R": {"seg_data": "SGN_v2", "stains": ["PV", "Calb1", "Ntng1"],
                    "subtype_stains": ["Calb1", "Ntng1"], "intensity": "ratio"},
    "M_LR_N127_L": {"seg_data": "SGN_v2", "stains": ["PV", "Prph", "Ntng1"],
                    "subtype_stains": ["Ntng1", "Prph"], "intensity": "ratio"},
    "M_LR_N152_L": {"seg_data": "SGN_v2", "stains": ["PV", "CR", "Ntng1"],
                    "subtype_stains": ["CR", "Ntng1"], "intensity": "ratio",
                    "component_list": [1, 2]},
    "M_LR_N152_R": {"seg_data": "SGN_v2", "stains": ["PV", "Calb1", "Ntng1"],
                    "subtype_stains": ["Calb1", "Ntng1"], "intensity": "ratio"},
    "M_AMD_N180_L": {"seg_data": "SGN_merged", "stains": ["CR", "Ntng1"],
                     "subtype_stains": ["CR", "Lypd1", "Ntng1"], "intensity": "absolute",
