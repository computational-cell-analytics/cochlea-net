...
def main():
    ...
    model_path = "/mnt/vast-nhr/projects/nim00007/data/moser/cochlea-lightsheet/trained_models/IHC/cellpose3-cyto3_ihc_2026-07-26" # noqa 

    # *** change to your google drive folder path ***
    if evaluation_mode == "validation":
        cochlea_dir = "/mnt/vast-nhr/projects/nim00007/data/moser/cochlea-lightsheet"
        input_dir = os.path.join(cochlea_dir, "training_data/IHC/2026-07_IHC-v11-data_cellpose3/val")
        out_dir = os.path.join(cochlea_dir, "predictions/val_ihc/cellpose3_finetuned_val")
    elif evaluation_mode == "revision":
        cochlea_dir = "/mnt/vast-nhr/projects/nim00007/data/moser/cochlea-lightsheet"
        input_dir = os.path.join(cochlea_dir, "AnnotatedImageCrops/F1ValidationIHCs")
        out_dir = os.path.join(cochlea_dir, "predictions/val_ihc/cellpose3_finetuned")
    else:
